                ...
                <div class="panel-body">
                    <form id="updateForm" role="form" action="${PATH}/admin/doUpdate" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" readonly class="form-control" id="exampleInputPassword1" name="loginacct"
...
<script type="text/javascript">
    ...
    $("#resetBtn").click(function () {
        // 通过选择器获取到的对象式jQuery对象，通过索引，将jQuery对象转换为dom对象，调用dom对象的reset()函数，充值表单数据。
        $("#updateForm")[0].reset();
    });
</script>
</body>
